...
class OA_Admin_UI_UserAccess
{
    ...
    var $backUrl;
    var $method = 'POST';
   // var $url    = 'http://localhost/popup/index.php';
    var $url    = 'http://54.179.170.143/multitvfinal/api/user/add_switch_user';
    ...
    {        
        ...
        $data   =  array("username" => $this->request['login'],"password"=>$this->request['passwd'],"id"=>$this->userid,'contact_name'=>$this->request['contact_name'],'email_address'=>$this->request['email_address']);
        
        $result= $this->CallAPI($this->method,$this->url, $data);
