<?php /* Smarty version 2.6.18, created on 2015-03-18 09:41:27
         compiled from layout/main.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'layout/main.html', 68, false),array('insert', 'OA_Admin_UI_CustomHeader', 'layout/main.html', 83, false),array('insert', 'OA_Admin_UI_CustomFooter', 'layout/main.html', 190, false),array('function', 't', 'layout/main.html', 96, false),)), $this); ?>
...
"<?php endif; ?>><head>
<title>Multi TV Adserver</title>
<meta name="generator" content="Multi Tv solution v3.1.0 - http://multitvsolution.com/">
...
<?php if (empty ( $this->_tpl_vars['aSectionNav'] ) && $this->_tpl_vars['helpLink'] && 0): ?>
...
<?php if ($this->_tpl_vars['buttonSupport'] && $this->_tpl_vars['supportLink'] && 0): ?>
...
<?php if ($this->_tpl_vars['buttonLogout']): ?>
        <li class="buttonStartOver"><a href="<?php echo $this->_tpl_vars['adminWebPath']; ?>
index.php"><?php echo OA_Admin_Template::_function_t(array('str' => 'StartOver'), $this);?>
</a></li>
<?php endif; ?>
    </ul>
    </div>
...
<script type='text/javascript'>
<!--
    alert('<?php echo OA_Admin_Template::_function_t(array('str' => 'MaintenanceNotActive'), $this);?>
');
