...
VIDEO_FORMAT_OPTION_JS;
       ...
       // $form->addElement('html', '', '<a class="ajax" href="popup/searchurl.phtml">Select Video</a>' );
        
        $vidoe_link[1] =  $form->createElement('html', 'video_status_info1', '<a class="ajax" href="popup/searchurl.phtml">Select Video</a>' );
        
        $form->addGroup($vidoe_link, 'vast_video_filename_group', ' &nbsp;&nbsp;&nbsp;&nbsp;', "", false);
        ...
        $form->addElement('text', 'vast_video_clickthrough_url', "Destination URL (incl. http://) <br />when user clicks on the video");
         ...
         $form->addElement('html', 'video_status_info2', '<script src="popup/jquery-1.10.2.js"></script><link rel="stylesheet" href="popup/colorbox.css" /><script src="popup/jquery.colorbox.js"></script>
        <script>
